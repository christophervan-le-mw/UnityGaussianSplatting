...
namespace GaussianSplatting.Runtime
{
    public class GaussianSplatRenderAsset : ScriptableObject
    {
        ...
        public byte[] posData => m_PosData;
        public byte[] colorData => m_ColorData;
        public byte[] otherData => m_OtherData;
        public byte[] shData => m_SHData;
        public byte[] chunkData => m_ChunkData;
